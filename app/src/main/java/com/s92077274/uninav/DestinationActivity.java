...
public class DestinationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void updateUI() {
        ...
        tvEstimatedTime.setText("Estimated Time: Calculating...");
    ...
    private void setClickListeners() {
        ...
        btnStartNavigation.setOnClickListener(v -> {
            ...
            navIntent.putExtra("is_live_location", isLiveLocationStart);
    ...
    private void drawSimulatedRoute() {
        if (googleMap == null) return;
    ...
    private void zoomToFitMarkers() {
        if (googleMap == null || startLocation == null || destinationLocation == null) return;
